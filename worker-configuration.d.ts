/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 843aee2a73c0bc929b0c875827e4001c)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 nodejs_compat
interface __BaseEnv_Env {
	OPENAI_API_KEY: string;
	OPENAI_MODEL: string;
	BRAINTRUST_API_KEY: string;
	DesignAgent: DurableObjectNamespace<import("./src/worker").DesignAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "DesignAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "OPENAI_MODEL" | "BRAINTRUST_API_KEY">> {}
}
